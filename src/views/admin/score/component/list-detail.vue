 ...
 * @LastEditTime: 2022-03-27 18:13:55
 * @LastEditors: liliang
 * @Description: 
 * @FilePath: /mba-score/src/views/admin/score/component/list-detail.vue
-->
  ...
  <section class="single-page">
    ...
    >
      <div class="import-layer">
        <div class="left">
          <div class="step">
            <div class="title">第一步：下载《活动学分信息表》并按要求添加信息</div>
            <div class="down-file">
              <el-button type="primary" plain @click="handleClick('downImport', '')"
                >《活动学分信息表》下载<el-icon class="el-icon--right"><download /></el-icon
              ></el-button>
            </div>
          </div>

          <div class="step">
            <div class="title">第二步：上传《活动学分信息表》文件</div>
...
<script lang="ts" setup>
  ...
  import mockData from '../../mockData/listDetail.json';
