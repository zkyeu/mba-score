 ...
 * @LastEditors: liliang
 * @LastEditTime: 2022-04-06 10:59:29
 * @FilePath: /score/src/views/admin/ucenter/as.vue
 * @Description: 
-->
<template>
  <section class="single-page">
    <div class="bread">
      <el-breadcrumb :separator-icon="ArrowRight">
        ...
        <el-breadcrumb-item :to="{ path: '/' }">活动查询</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="btn">
...
<script lang="ts" setup>
  ...
  import mockData from '../mockData/as.json';
