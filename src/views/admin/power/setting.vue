<!--
 * @Author: liliang
 * @Date: 2022-04-06 13:47:11
 * @LastEditors: liliang
 * @LastEditTime: 2022-04-06 13:48:05
 * @FilePath: /score/src/views/admin/power/setting.vue
 * @Description: 
-->
  ...
  <section class="single-page">
    <div class="bread">
      <el-breadcrumb :separator-icon="ArrowRight">
        ...
        <el-breadcrumb-item :to="{ path: '/' }">基础字段配置</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <!-- <div class="add-role">
